package by.intexsoft.progcomm.config;
...
@ComponentScan("by.intexsoft.progcomm.service")
@PropertySource("classpath:app.properties")
@EnableJpaRepositories("by.intexsoft.progcomm.repository")
public class DatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan("by.intexsoft.progcomm.entity");
